...
import kr.co.unionsystems.dataware.service.CustomerStoryService;
...
@RestController("datawareCustomerStoryController")
@RequestMapping("/api/dataware/customer-stories")
