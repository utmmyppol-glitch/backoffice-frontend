        ...
        {selected && (
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div><span className="text-xs text-gray-500">교육명</span><p className="text-sm font-medium">{selected.courseName}</p></div>
              <div><span className="text-xs text-gray-500">희망 일자</span><p className="text-sm">{selected.preferredDate || "-"}</p></div>
